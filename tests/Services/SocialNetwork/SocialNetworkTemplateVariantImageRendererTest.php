 ...
 *
 * @covers \WBoost\Web\Services\SocialNetwork\SocialNetworkTemplateVariantImageRenderer
 */
final class SocialNetworkTemplateVariantImageRendererTest extends TestCase
{
    ...
    private function invokeAlign(array $canvas, array $inputs): array
    {
        ...
        $renderer = new SocialNetworkTemplateVariantImageRenderer(
