...
/**
 * @covers \WBoost\Web\Api\FlyerTemplates\FlyerTemplateResponse
 * @covers \WBoost\Web\Api\FlyerTemplates\FlyerTemplateVariantResponse
 * @covers \WBoost\Web\Api\FlyerTemplates\FlyerTemplateVariantInputResponse
 * @covers \WBoost\Web\Api\FlyerTemplates\FlyerTemplateVariantImageInputResponse
 * @covers \WBoost\Web\Api\FlyerTemplates\FlyerTemplateVariantImageInputFrameResponse
 * @covers \WBoost\Web\Api\FlyerTemplates\FlyerTemplatesProvider
 */
final class FlyerTemplatesTest extends ApiTestCase
{
    public function testRequiresAuthentication(): void
    {
        $client = self::createClient();
        $client->request('GET', '/api/projects/' . TestDataFixture::PROJECT_1_ID . '/flyer-templates');
    ...
    public function testReturnsTemplatesForRequestedProject(): void
    {
        ...
        $response = $client->request('GET', '/api/projects/' . TestDataFixture::PROJECT_1_ID . '/flyer-templates', [
        ...
        self::assertContains(TestDataFixture::FLYER_TEMPLATE_1_ID, $ids);
        self::assertNotContains(
            TestDataFixture::FLYER_TEMPLATE_2_ID,
            $ids,
    ...
    public function testReturnsNotFoundForProjectOwnedByAnotherUser(): void
    {
        ...
        $client->request('GET', '/api/projects/' . TestDataFixture::PROJECT_2_ID . '/flyer-templates', [
            'headers' => ['Authorization' => 'Bearer ' . $token],
        ]);
    ...
    public function testEmbedsVariantsWithFreeFormDimension(): void
    {
        ...
        $template = self::findTemplate($body, TestDataFixture::FLYER_TEMPLATE_1_ID);

        self::assertSame('Flyer Template 1', $template['name'] ?? null);
        ...
        self::assertSame(TestDataFixture::FLYER_TEMPLATE_VARIANT_1_ID, $variant['id'] ?? null);
        ...
        self::assertStringContainsString(
            '/api/flyer-template-variants/' . TestDataFixture::FLYER_TEMPLATE_VARIANT_1_ID . '/thumbnail',
        ...
        self::assertSame(TestDataFixture::FLYER_VARIANT_1_INPUT_HEADLINE_ID, $headline['id'] ?? null);
        ...
        self::assertSame(TestDataFixture::FLYER_VARIANT_1_IMAGE_PHOTO_ID, $photo['id'] ?? null);
