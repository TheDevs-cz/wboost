...
/**
 * @covers \WBoost\Web\Api\FlyerTemplates\PlaceholderGalleryProvider
 * @covers \WBoost\Web\Api\FlyerTemplates\PlaceholderGalleryImageResponse
 */
final class FlyerPlaceholderGalleryTest extends ApiTestCase
{
    ...
    public function testForbidsVariantInOtherUsersProject(): void
    {
        ...
        $client->request('GET', $this->galleryUrl(
            TestDataFixture::FLYER_TEMPLATE_VARIANT_2_ID,
            TestDataFixture::FLYER_VARIANT_1_IMAGE_PHOTO_ID,
        ), ['headers' => ['Authorization' => 'Bearer ' . $token]]);
