...
/**
 * @covers \WBoost\Web\Value\FlyerDimension
 * @covers \WBoost\Web\Value\DimensionUnit
 */
final class FlyerDimensionTest extends TestCase
{
    public function testPixelsArePassedThroughUnchanged(): void
    {
        $dimension = new FlyerDimension(DimensionUnit::Px, 1080, 1920);
    ...
    public function testMillimetersRasterizeAt300Dpi(): void
    {
        ...
        $dimension = new FlyerDimension(DimensionUnit::Mm, 210, 297);
    ...
    public function testCentimetersRasterizeAt300Dpi(): void
    {
        ...
        $dimension = new FlyerDimension(DimensionUnit::Cm, 21, 29.7);
    ...
    {
        $dimension = new FlyerDimension(DimensionUnit::Px, 100.4, 100.6);
