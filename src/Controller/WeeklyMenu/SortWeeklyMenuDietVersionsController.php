...
final class SortWeeklyMenuDietVersionsController extends AbstractController
{
    ...
    #[Route(path: '/weekly-menu/{menuId}/sort-diet-versions/{variantId}', name: 'sort_weekly_menu_diet_versions', methods: ['POST'])]
    #[IsGranted(WeeklyMenuVoter::EDIT, 'menu')]
    public function __invoke(
        #[MapEntity(id: 'menuId')]
        WeeklyMenu $menu,
        #[MapEntity(id: 'variantId')]
        WeeklyMenuMealVariant $variant,
        Request $request,
    ): JsonResponse {
        ...
        $this->bus->dispatch(
            new SortWeeklyMenuDietVersions($variant->id, $sortedIds),
        );
