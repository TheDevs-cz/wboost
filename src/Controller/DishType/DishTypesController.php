...
final class DishTypesController extends AbstractController
{
    ...
    #[Route(path: '/project/{projectId}/dish-types', name: 'dish_types')]
    ...
    public function __invoke(
        ...
        return $this->render('dish_types.html.twig', [
            'project' => $project,
