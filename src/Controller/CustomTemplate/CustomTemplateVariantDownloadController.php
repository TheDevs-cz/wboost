 ...
 * full reasoning).
 */
final class CustomTemplateVariantDownloadController extends AbstractController
{
    ...
    #[Route(
        path: '/custom-template-variant/{variantId}/download',
        name: 'custom_template_variant_download',
        methods: ['POST'],
    )]
