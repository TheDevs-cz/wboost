...
final class SortFlyerCategoriesController extends AbstractController
{
    ...
    #[Route(path: '/sort-flyer-categories/{projectId}', name: 'sort_flyer_categories')]
    ...
    ): JsonResponse
    {
        ...
        $this->bus->dispatch(
            new SortFlyerCategories($sorted)
        );
