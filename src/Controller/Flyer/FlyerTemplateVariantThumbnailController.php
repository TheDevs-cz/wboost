...
/**
 * Public API: stream a flyer variant's thumbnail — its cached preview render
 ...
 */
final class FlyerTemplateVariantThumbnailController extends AbstractController
{
    ...
    #[Route(
        path: '/api/flyer-template-variants/{variantId}/thumbnail',
        name: 'api_flyer_template_variant_thumbnail',
        methods: ['GET'],
    )]
