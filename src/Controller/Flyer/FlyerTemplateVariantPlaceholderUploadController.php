...
/**
 * Public API parity for "upload your own image during fill" on flyer variants:
 ...
 * {@see FlyerTemplateVariantPlaceholderUploadWebController}.
 */
final class FlyerTemplateVariantPlaceholderUploadController extends AbstractController
{
    ...
    #[Route(
        path: '/api/flyer-template-variants/{variantId}/placeholders/{inputId}/images',
        name: 'api_flyer_template_variant_placeholder_upload',
        methods: ['POST'],
    )]
