...
final class SortTemplateCategoriesController extends AbstractController
{
    ...
    #[Route(path: '/sort-template-categories/{projectId}', name: 'sort_template_categories')]
    ...
    ): JsonResponse
    {
        ...
        $this->bus->dispatch(
            new SortTemplateCategories($sorted)
        );
