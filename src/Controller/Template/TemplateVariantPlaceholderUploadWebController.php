...
/**
 * Session-authed "upload your own image during fill" for the template web fill
 * page — the in-browser counterpart of the OAuth API upload endpoint.
 */
final class TemplateVariantPlaceholderUploadWebController extends AbstractController
{
    ...
    #[Route(
        path: '/template-variant/{variantId}/placeholders/{inputId}/upload',
        name: 'template_variant_placeholder_upload',
        methods: ['POST'],
    )]
