...
a filled text that wraps to more lines pushes the flow items below it down,
hidden items collapse. Containers can NEST (`memberContainerIds` + `nested`):
...
final readonly class TemplateVariantResource
{
}
