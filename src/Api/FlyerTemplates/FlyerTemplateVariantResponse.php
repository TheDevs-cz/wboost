...
final readonly class FlyerTemplateVariantResponse
{
    /**
     * Flyer dimensions are free-form (the designer chose a unit + size, with
     ...
     *
     * @param list<FlyerTemplateVariantInputResponse> $inputs
     * @param list<FlyerTemplateVariantImageInputResponse> $imageInputs
     */
