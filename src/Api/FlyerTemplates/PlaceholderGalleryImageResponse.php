...
/**
 * One gallery image a consumer may drop into a specific flyer image
 ...
 */
#[ApiResource(
    shortName: 'FlyerPlaceholderGalleryImage',
    operations: [
        new GetCollection(
            uriTemplate: '/flyer-template-variants/{variantId}/placeholders/{inputId}/images',
