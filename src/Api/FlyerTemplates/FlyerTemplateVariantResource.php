...
#[ApiResource(
    shortName: 'FlyerTemplateVariant',
    operations: [
        new Post(
            uriTemplate: '/flyer-template-variants/{id}/export',
            input: ExportRequest::class,
            output: false,
            read: false,
            processor: ExportProcessor::class,
            security: "is_granted('IS_AUTHENTICATED_FULLY')",
            name: 'api_flyer_template_variant_export',
            openapi: new OpenApiOperation(
                summary: 'Render a flyer template variant to PNG',
                description: <<<MD
...
- List a slot's pickable images via
  `GET /api/flyer-template-variants/{variantId}/placeholders/{inputId}/images`;
...
final readonly class FlyerTemplateVariantResource
{
}
