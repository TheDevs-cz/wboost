...
#[ApiResource(
    ...
    operations: [
        new GetCollection(
            ...
            uriVariables: [
                'projectId' => new Link(
                    fromClass: CustomTemplateResponse::class,
                    identifiers: [],
                    parameterName: 'projectId',
                ),
            ],
            provider: CustomTemplatesProvider::class,
...
final readonly class CustomTemplateResponse
{
    /**
     * @param list<CustomTemplateVariantResponse> $variants
     */
