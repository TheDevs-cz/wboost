...
/**
 * @extends Voter<string, CustomTemplate>
 */
final class CustomTemplateVoter extends Voter
{
    public const string ADD = 'custom_template_add';
    public const string VIEW = 'custom_template_view';
    public const string EDIT = 'custom_template_edit';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        return $subject instanceof CustomTemplate;
    }
