...
/**
 * @extends Voter<string, CustomTemplateVariant>
 */
final class CustomTemplateVariantVoter extends Voter
{
    public const string ADD = 'custom_template_variant_add';
    public const string VIEW = 'custom_template_variant_view';
    public const string EDIT = 'custom_template_variant_edit';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        return $subject instanceof CustomTemplateVariant;
    }
