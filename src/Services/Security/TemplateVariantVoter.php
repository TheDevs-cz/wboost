...
/**
 * @extends Voter<string, TemplateVariant>
 */
final class TemplateVariantVoter extends Voter
{
    public const string ADD = 'template_variant_add';
    public const string VIEW = 'template_variant_view';
    public const string EDIT = 'template_variant_edit';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        return $subject instanceof TemplateVariant;
    }
