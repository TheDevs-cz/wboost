...
/**
 * @extends Voter<string, FlyerTemplate>
 */
final class FlyerTemplateVoter extends Voter
{
    public const string ADD = 'flyer_template_add';
    public const string VIEW = 'flyer_template_view';
    public const string EDIT = 'flyer_template_edit';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        return $subject instanceof FlyerTemplate;
    }
