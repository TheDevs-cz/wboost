...
/**
 * @extends Voter<string, FlyerTemplateVariant>
 */
final class FlyerTemplateVariantVoter extends Voter
{
    public const string ADD = 'flyer_variant_add';
    public const string VIEW = 'flyer_variant_view';
    public const string EDIT = 'flyer_variant_edit';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        return $subject instanceof FlyerTemplateVariant;
    }
