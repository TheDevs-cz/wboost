...
namespace WBoost\Web\Twig\Components\CustomTemplate;
 ...
 * routes.
 */
#[AsLiveComponent('CustomTemplate:VariantFiller', template: 'components/VariantFiller.html.twig')]
final class VariantFiller extends AbstractVariantFiller
{
     ...
     */
    #[LiveProp]
    public null|CustomTemplateVariant $variant = null;

    protected function nullableVariant(): null|CustomTemplateVariant
    {
        return $this->variant;
    }
    ...
    {
        return CustomTemplateVariantVoter::VIEW;
    }

    public function downloadPath(): string
    {
        return $this->generateUrl('custom_template_variant_download', [
    ...
    {
        return $this->generateUrl('custom_template_variant_placeholder_upload', [
            'variantId' => $this->variantEntity()->id,
            'inputId' => $inputId,
        ]);
    }
