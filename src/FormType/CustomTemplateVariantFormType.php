...
/**
 * @extends AbstractType<CustomTemplateVariantFormData>
 */
final class CustomTemplateVariantFormType extends AbstractType
{
    /**
     * @param mixed[] $options
     */
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => CustomTemplateVariantFormData::class,
        ]);
    }
}
